...
export default function CreatePost() {
  ...
  const handleReset = () => {
    if (postId) dispatch(cancelEditPost())
    setFormData(initialState)
  }
  ...
  return (
    <form onSubmit={handleSubmit} onReset={handleReset}>
      ...
      <div className='mb-6'>
        <label htmlFor='featuredImage' className='block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300'>
          Featured Image
        </label>
        <input
          type='text'
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          className={classNames(
            ...
            {
              'border-gray-300 bg-gray-50 text-gray-900 focus:border-blue-500 ': !Boolean(errorForm?.publishDate),
